"""
Apply phase_5b_matches.sql against the live DB.

Same transaction semantics as _dryrun_5b.py — but COMMITs on success.
...
sql = sql.replace("COMMIT;", "-- COMMIT; (issued by _apply_5b.py after audit pass)")
...
try:
    ...
    # Capture the final eyeball SELECT
    ...
    conn.commit()
    print("\nCOMMIT OK — Phase 5b matches table + auto-link backfill is live.")
