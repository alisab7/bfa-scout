"""
Apply passport_holders.sql against the live DB. Same transaction
...
sql_path = Path(__file__).parent / "passport_holders.sql"
...
try:
    ...
    cur.execute(sql)
    conn.commit()
    print("COMMIT OK -- origin_country / origin_country_code added.")
