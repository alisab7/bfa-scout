"""
Apply squad_members.sql against the live DB. Same transaction semantics
...
sql_path = Path(__file__).parent / "squad_members.sql"
...
try:
    ...
    cur.execute(sql)
    conn.commit()
    print("COMMIT OK -- squad_members table is live.")
