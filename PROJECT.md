...
| **Phase 8.1: Security hardening** | **✅ Complete** | nginx login rate limit (10/min, burst 5); password complexity (≥8, upper+lower+digit+special; Phase 8.1.1 revised from ≥12); 8hr sliding session timeout + secure cookie flags. v1.0.1 |
